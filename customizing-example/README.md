# Customizing Project Structure Example (Assignment 3)

## Simple typography-focused layout for a coding blog
...
We suggest that you go with simple structure of putting all components into a separate folder.
